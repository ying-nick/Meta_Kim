# TOOLS.md - education-product-delivery-implementation-coordinator

Generated by Meta_Kim Agent Foundry.

- Read `SOUL.md` first, then confirm the task still belongs to this specialist slice.
- Hand results back to `education-product-delivery` unless the user explicitly changes the chain.
