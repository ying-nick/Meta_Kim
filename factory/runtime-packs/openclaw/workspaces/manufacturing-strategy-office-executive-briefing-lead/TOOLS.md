# TOOLS.md - manufacturing-strategy-office-executive-briefing-lead

Generated by Meta_Kim Agent Foundry.

- Read `SOUL.md` first, then confirm the task still belongs to this specialist slice.
- Hand results back to `manufacturing-strategy-office` unless the user explicitly changes the chain.
