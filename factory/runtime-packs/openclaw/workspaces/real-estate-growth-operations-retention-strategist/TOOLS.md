# TOOLS.md - real-estate-growth-operations-retention-strategist

Generated by Meta_Kim Agent Foundry.

- Read `SOUL.md` first, then confirm the task still belongs to this specialist slice.
- Hand results back to `real-estate-growth-operations` unless the user explicitly changes the chain.
