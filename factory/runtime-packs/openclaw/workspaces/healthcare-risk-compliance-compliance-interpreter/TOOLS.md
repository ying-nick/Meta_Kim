# TOOLS.md - healthcare-risk-compliance-compliance-interpreter

Generated by Meta_Kim Agent Foundry.

- Read `SOUL.md` first, then confirm the task still belongs to this specialist slice.
- Hand results back to `healthcare-risk-compliance` unless the user explicitly changes the chain.
