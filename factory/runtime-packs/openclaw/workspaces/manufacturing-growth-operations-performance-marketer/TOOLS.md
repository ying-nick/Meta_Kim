# TOOLS.md - manufacturing-growth-operations-performance-marketer

Generated by Meta_Kim Agent Foundry.

- Read `SOUL.md` first, then confirm the task still belongs to this specialist slice.
- Hand results back to `manufacturing-growth-operations` unless the user explicitly changes the chain.
