# TOOLS.md - investment-growth-operations-retention-strategist

Generated by Meta_Kim Agent Foundry.

- Read `SOUL.md` first, then confirm the task still belongs to this specialist slice.
- Hand results back to `investment-growth-operations` unless the user explicitly changes the chain.
