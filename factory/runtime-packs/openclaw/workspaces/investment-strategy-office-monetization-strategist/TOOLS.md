# TOOLS.md - investment-strategy-office-monetization-strategist

Generated by Meta_Kim Agent Foundry.

- Read `SOUL.md` first, then confirm the task still belongs to this specialist slice.
- Hand results back to `investment-strategy-office` unless the user explicitly changes the chain.
